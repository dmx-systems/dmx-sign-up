...
public class Constants {
    ...
    public static final String CONFIG_CUSTOM_CSS_PATH = "dmx.signup.config_custom_css_path";
    ...
    public static final String CONFIG_LOADING_APP_HINT = "dmx.signup.loading_app_hint";
